...
export default function AnalyticsPage() {
  ...
  // New: business display name for header
  ...
  // New: fetch business name once we know the id
  useEffect(() => {
  ...
  /* ---------- Open excerpt -> fetch full review (business-scoped) ---------- */
    ...
    <div className="min-h-screen w-full text-gray-900">
      ...
      <div className="ml-48">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
          {/* Header (replaced): “[business name] Analytics” + Refresh */}
      ...
      >
        <div className="mb-4 flex items-center justify-between">
          <div className="flex items-baseline gap-3 min-w-0">
            ...
            <span className="text-xs text-gray-500 shrink-0">Click an excerpt to view the full review</span>
          </div>
          <button
            type="button"
            onClick={onClose}
...
function MetricCard({
  ...
  // Same background effect as tables (transparent + backdrop contrast), no border/rounded/shadow
  return (
