  ...
  return (
    <div className="min-h-screen w-full">
      ...
      <div className="mx-auto max-w-6xl">
        ...
        {/* Error banners */}
        {resolveErr && <div className="mb-4 rounded-lg border border-red-200 bg-red-50 px-3 py-2 text-sm text-red-700">{resolveErr}</div>}
        ...
        <div className="mb-4 flex items-center justify-between rounded-xl border border-gray-200 bg-white px-4 py-3 shadow-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              disabled={!businessId || selectedIds.size === 0 || bulkSending}
 ...
 *      • if clickAt most recent → "Button clicked" (amber)
